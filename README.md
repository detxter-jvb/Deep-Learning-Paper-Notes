...
# 2026-09
- [3D-ADAPTER: GEOMETRY-CONSISTENT MULTI-VIEW DIFFUSION FOR HIGH-QUALITY 3D GENERATION](https://arxiv.org/pdf/2410.18974v2) Novel View Realism Metric : MDD
...
- [EvoDrive: Pareto Evolution for Safety-Critical Autonomous Driving via Self-Improving LLM Agents](https://arxiv.org/pdf/2606.03678) <kbd>arXiv, 2026-06-02</kbd> 
- [RiskFlow: Fast and Faithful Safety-Critical Traffic Scenario Generation](https://arxiv.org/pdf/2606.06423) <kbd>arXiv 2026-06-04</kbd>
...
- [ReSim: Reliable World Simulation for Autonomous Driving](https://arxiv.org/abs/2506.09981) <kbd>NeurIPS 2025</kbd> NVIDIA
...
- [A Hierarchical 3D Gaussian Representation for Real-Time Rendering of Very Large Datasets](https://arxiv.org/pdf/2406.12080) must be referred for alpha blending and redering insight
